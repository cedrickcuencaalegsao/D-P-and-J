...
class RegisterProduct
{
    ...
    public function create(string $product_id, string $name,  float $price,  string $created_at, string $updated_at)
    {
        $data = new Product(null, $product_id, $name,  $price, $created_at, $updated_at);
